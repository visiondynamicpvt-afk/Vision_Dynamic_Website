...
const teamMembers: TeamMember[] = [
  {
    ...
    instagram: "https://www.instagram.com/_rajnishchaudhary_/",
    facebook: "https://www.facebook.com/rajnishchaudhary00",
    image: rajnishImage,
  },
  {
    id: 2,
          ...
          <div className="flex flex-col md:flex-row">
            ...
            <div className="w-full md:w-3/5 p-6 sm:p-8 md:p-12 flex flex-col justify-center space-y-6 text-left">
              ...
              <div className="flex gap-4 pt-4">
                ...
                <a href={teamMembers[0].facebook} target="_blank" rel="noopener noreferrer" className="p-2 bg-secondary rounded-full hover:bg-primary hover:text-primary-foreground transition-colors">
                  <svg className="w-5 h-5 flex-shrink-0" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                    <path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.469h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.469h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z" />
                  </svg>
                </a>
                <a href={teamMembers[0].instagram} target="_blank" rel="noopener noreferrer" className="p-2 bg-secondary rounded-full hover:bg-primary hover:text-primary-foreground transition-colors">
                  <svg className="w-5 h-5 flex-shrink-0" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
